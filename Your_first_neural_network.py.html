...
quant_features = ['casual', 'registered', 'cnt', 'windspeed', 'temp', 'hum']
...
for each in quant_features:
    ...
    index = column_index.get_loc(each)
    print(each,index)
    #data.iloc[:, index] = (data.loc[:,each] - mean)/std
...
for ii in range(iterations):
    ...
    #print("train_features:", train_features.head)
